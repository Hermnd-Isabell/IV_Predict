...
STEP1_SAM = PROJECT_ROOT / "output" / "spx_step1_v2" / "sam_features.npz"
STEP1_PCA = PROJECT_ROOT / "output" / "spx_step1_v2" / "pca_features.npz"
STEP1_VAE = PROJECT_ROOT / "output" / "spx_step1_v2" / "vae_features.npz"
RAW_DATA = PROJECT_ROOT / "data" / "raw" / "spx_options_2009_2020.csv"
RATE_DATA = PROJECT_ROOT / "data" / "raw" / "rate_cleaned_2009_2020.csv"
OUTPUT_DIR = PROJECT_ROOT / "output" / "spx_step2_v2"
...
def run_step2(feature_type, data_dict, grid_df, model_class=DNN_Surface,
    ...
    print(f"\n{'=' * BANNER_WIDTH}")
    print(f"Step 2 v2: {model_name} ({feature_type})")
...
def main():
    ...
    print(f"\n[Done] Step 2 v2 完成，输出保存到: {OUTPUT_DIR}")
