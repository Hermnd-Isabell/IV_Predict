...
输入: data/raw/spx_options_2009_2020_clean.csv
输出: output/spx_step0_v3/
"""
...
DATA_PATH = PROJECT_ROOT / "data" / "raw" / "spx_options_2009_2020_clean.csv"
RATE_PATH = PROJECT_ROOT / "data" / "raw" / "rate_cleaned_2009_2020.csv"
OUTPUT_DIR = PROJECT_ROOT / "output" / "spx_step0_v3"
...
def main() -> None:
    ...
    print("\n[Run] 开始 Step 0 v3 插值（固定 154 维网格）...")
