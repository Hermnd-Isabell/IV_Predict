...
OUTPUT_DIR = PROJECT_ROOT / "output" / "spx_step2_v3_kan"
...
def main():
    ...
    for feature_type in ["SAM", "VAE"]:
        ...
        model, hist, rmse, mape, Lcal, Lbut = run_step2_kan_arbitrage(
            ...
            model_kwargs={"hidden_dim": 32, "kan_hidden": 16, "num_layers": 2},
